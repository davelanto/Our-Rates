...
$('#seaimportModal').on('hidden.bs.modal', function (e) {
    $(this)
      .find("input")
         .val('')
         .end();
  ...
  var myModalEl = document.getElementById('seaimportModal')
...
$(".edit").click(function () {
  ...
  $('#validity', myModal).val(columnValues[10].trim());
