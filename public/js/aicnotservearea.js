...
$('#aic_not_serve_area_modal').on('hidden.bs.modal', function (e) {
    $(this)
      .find("input")
         .val('')
         .end();
  ...
  var myModalEl = document.getElementById('aic_not_serve_area_modal')
...
$(".edit").click(function () {
  ...
  var myModal = $('#aic_not_serve_area_modal');
