...
$('#seaexportLCLModal').on('hidden.bs.modal', function (e) {
    $(this)
      .find("input")
         .val('')
         .end()
  ...
  var myModalEl = document.getElementById('seaexportLCLModal')
...
$(".edit").click(function () {
  ...
  $('#amount', myModal).val(columnValues[7].trim());
  $('#remarks', myModal).val(columnValues[8].trim());
