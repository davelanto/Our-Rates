...
use App\Models\AicOdaModel;
use CodeIgniter\Controller;


class AicOda extends BaseController
{
    ...
    public function index()
    {
        ...
        $model = new AicOdaModel(); 
        $title['title'] = "Out of Delivery Areas";

        $data['aicoda'] = $model->read();
        $data['lastupdate'] = $model->lastupdate();
        
        echo view('templates/header',$title);
        echo view('pages/aicoda',$data);
