...
class SeaimportFCLModel extends Model
{
    ...
    protected $allowedFields = [
     'sea_air_id', 'group_id', 'charge','currency','twenty', 'forty', 'fortyhq', 'remarks', 'last_update', 'user_id'
    ];
    ...
    public function getnotes()
    {
        ...
        $builder->where('notes_for','SeaImpFCL');
        $query = $builder->get();
