<div class="container">
    ...
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <h5 class="text-uppercase text-danger">Freeport Zone Charges</h5>
        <div class="">
    ...
    <div class="text-start col mb-2">
        <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#BrokerageFportModal">New Rate <i class="fas fa-plus fa-fw"></i></button>
    </div>

    <?php endif; ?>

    <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#brokerageFportNotes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>
    ...
    <div class="mt-2">
         <h6 class="fw-bold text-secondary">SUBIC/CLARK Shipment(Manila as POD)</h6>
    </div>
    ...
    ?>
                    ...
                    <thead class= "bg-dark text-light text-justify">
                        ...
                        <tbody >
                            ...
                            if ($BrokerageFport) {
                                ...
                                foreach($BrokerageFport->getResult() as $rate)
                                {
                            ...
                            ?>
                                ...
                                <?php if($this->session->user_type == 'Editor'): ?>
                                        ...
                                        <td class="col-action"><a href="<?=base_url('BrokerageFport/delete/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
                                <?php endif; ?>
        ...
        <?php
            ...
            <?php if($this->session->user_type == 'Editor'): ?> 
                <form method="POST" action="<?=base_url('BrokerageFport/add');?>" class="needs-validation" novalidate>
                    <div class="modal fade" id="BrokerageFportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="BrokerageFportModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title fw-bold poppins text-secondary" id="BrokerageFportModalLabel">Brokerage <br> <span class="text-danger fw-light"> Freeport Zone Charges </span> </h6>
            ...
            <form action="<?=base_url('brokerageFport/updatenotes');?>" method="post">

<div class="modal fade" id="brokerageFportNotes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="brokerageFportNoteslabel" aria-hidden="true">
<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title fw-bold poppins text-secondary" id="brokerageFportNoteslabel">Editor's Note</h6>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
            <div class="modal-body poppins">
            <?php if ($note) : ?>
...
<script src="<?=base_url('js/BrokerageFport.js');?>"></script>