...
<?php  $this->session = \Config\Services::session(); ?>
    ...
    <div class="row">
            ...
            <div class="text-end col mb-2">
                <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#seaexportFCLNotes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
            </div>
    ...
    <?php endif; ?>
        ...
        <form action="<?=base_url('seaexportFCL/updatenotes');?>" method="post">

            <div class="modal fade" id="seaexportFCLNotes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="seaexportFCLNoteslabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title fw-bold poppins text-secondary" id="seaexportFCLNoteslabel">Editor's Note</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                        <div class="modal-body poppins">
                        <?php if ($note) : ?>
