...
<div class="container">
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <?php  $this->session = \Config\Services::session(); ?>
            ...
            <h5 class="text-uppercase">Airspeed Boxes</h5>
    ...
    <div class="row">
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <div class="text-start col mb-2">
                <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#aic_boxes_modal">New Rate <i class="fas fa-plus fa-fw"></i></button>
            </div>

        <?php endif; ?>

        <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#aic_boxes_notes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>

    </div>

    <div class="mb-2 bg-light p-4 border border-secondary rounded" >
    <h6 class="text-success">AIRSPEED BOXES</h6>
         <table class="table table-striped table-responsive" style="width:100%; overflow-x:auto;">
            ...
            <thead class="bg-dark text-light">
                ...
                <th colspan="1">SIZES</th>
                <th>MAXIMUM WEIGHT (kg)</th>
                <th>DIMENSION <br> <span class="text-warning">(cm: L x W x H)</span></th>
                <th>METRO MANILA</th>
                <th>LUZON</th>
                <th>VISAYAS</th>
                <th>MINDANAO</th>
            ...
            <tbody>
                ...
                <?php if($aicboxes): ?>
                    ...
                    <?php foreach($aicboxes->getResult() as $rate ): ?>

                        <?php if($rate->category == 'REGULAR'): ?>

                        <tr>
                            <?php if($this->session->user_type == 'Editor'): ?>
                                
                                <td><button type="button" class="btn btn-primary btn-sm edit" id="edit" >Edit</button></td>
                                <td><a href="<?=base_url('aicboxes/delete/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
    ...
    <div class="mb-2 mt-5 bg-light p-4 border border-secondary rounded" >
                    ...
                    <h6 class="text-success">IN EXCESS PRICE PER KILO</h6>
        ...
        <table class="table table-striped table-responsive" style="width:100%; overflow-x:auto;">
            ...
            <thead class="bg-dark text-light">
                ...
                <?php if($this->session->user_type == 'Editor'): ?>
                    ...
                    <th class="col-action2">Action</th>
                    <th class="col-action2">Action</th>
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
        <form method="post" action="<?=base_url('aicboxes/add');?>" class="needs-validation" novalidate >
            
            <div class="modal fade" id="aic_boxes_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="aic_boxes_modallabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-bold poppins text-secondary" id="aic_boxes_modallabel">Airspeed Boxes</h6>
                            ...
                            <div class="modal-body poppins">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <option value="REGULAR">Airspeed Boxes</option>
                                        <option value="EXCESS">Excess Price per Kilo</option>
                                        </select>
                                    ...
                                    <div class="col">
                                        <label for="size" class="form-label">Size</label>
                                            <input type="text" class="form-control form-control-sm" autocomplete="off"  id="size" name="size" required>
                                                <div id="sizefeedback" class="invalid-feedback"> This Field is Required </div>
                                        
                                    </div>

                                    <div class="col">
                                        <label for="max_weight" class="form-label">Max Weight </label>
                                            <input type="text" class="form-control form-control-sm" autocomplete="off"  id="max_weight" name="max_weight" required>
                                                <div id="max_weightfeedback" class="invalid-feedback"> This Field is Required </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label for="dimension" class="form-label">Dimension</label>
                                            <input type="text" class="form-control form-control-sm" autocomplete="off"  id="dimension" name="dimension" required>
                                                <div id="dimensionfeedback" class="invalid-feedback"> This Field is Required </div>
                                        
                                    </div>

                                    <div class="col">
                                        <label for="ncr" class="form-label">Metro Manila</label>
    ...
    <?php endif; ?>
        ...
        <form action="<?=base_url('aicboxes/updatenotes');?>" method="post">

             <div class="modal fade" id="aic_boxes_notes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="asp_air_freight_noteslabel" aria-hidden="true">
...
<script src="<?=base_url('js/aicboxes.js');?>"></script>