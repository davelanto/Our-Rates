...
<div class="container">
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <?php  $this->session = \Config\Services::session(); ?>
            ...
            <h5 class="text-uppercase">Sea Freight FCL Rate</h5>
    ...
    <div class="row">
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <div class="text-start col mb-2">
                <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#asp_sea_freight_fcl_modal">New Rate <i class="fas fa-plus fa-fw"></i></button>
            </div>

        <?php endif; ?>

        <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#asp_sea_freight_fcl_notes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>
    ...
    <table class="table table-striped table-responsive" style="width:100%; overflow-x:auto;">
            ...
            <thead class="bg-dark text-light">
                ...
                <th scope="col"> <span class="text-warning fw-bolder">EX MNL</span> <br> Destination</th>
                <th scope="col"> <span class="text-warning fw-bolder">PER TEU</span></th>
           
                </tr>
            </thead>
            <tbody>
                
                <?php if($aspseafreightfcl): ?>

                    <?php foreach($aspseafreightfcl->getResult() as $rate ): ?>

                        <tr>
                            <?php if($this->session->user_type == 'Editor'): ?>
                                
                                <td><button type="button" class="btn btn-primary btn-sm edit" id="edit" >Edit</button></td>
                                <td><a href="<?=base_url('aspseafreightfcl/delete/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
    ...
    <?php if($this->session->user_type == 'Editor'): ?>
        ...
        <form method="post" action="<?=base_url('aspseafreightfcl/add');?>" class="needs-validation" novalidate >
            
            <div class="modal fade" id="asp_sea_freight_fcl_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="asp_air_freight_modallabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-bold poppins text-secondary" id="asp_air_freight_modallabel">Sea Freight FCL Rate</h6>
                            ...
                            <div class="modal-body poppins">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label for="area" class="form-label">Freight Cost</label>
                                            <input type="text" class="form-control form-control-sm" autocomplete="off"  id="freight_cost" name="freight_cost" required>
                                                <div id="freight_costfeedback" class="invalid-feedback"> This Field is Required </div>
    ...
    <?php endif; ?>
        ...
        <form action="<?=base_url('aspseafreightfcl/updatenotes');?>" method="post">

             <div class="modal fade" id="asp_sea_freight_fcl_notes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="asp_air_freight_noteslabel" aria-hidden="true">
...
<script src="<?=base_url('js/aspseafreightfcl.js');?>"></script>