<div class="container">
    ...
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <h5 class="text-uppercase text-danger">OCEAN FREIGHT</h5>
   ...
   <div class="row">
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <div class="text-start col mb-2">
                <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#seaimportModal">New Rate <i class="fas fa-plus fa-fw"></i></button>
            </div>

        <?php endif; ?>

        <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#seaimportNotes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>
    ...
    <div class=" mb-2 bg-light p-4 border border-secondary rounded" >
            ...
            <table class="table table-striped  table-responsive" style="width:100%; overflow-x:auto;" >
                    ...
                    <tbody >
                        ...
                        if ($seaimport) {
                            ...
                            foreach($seaimport->getResult() as $rate)
                            {
                        ?>
                            <tr>
                        ...
                        <?php if($this->session->user_type == 'Editor'): ?>
                                    ...
                                    <td class="col-action"><a href="<?=base_url('seaimport/delete/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
                        <?php endif; ?>
                        <?php
                            echo'
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <form method="POST" action="<?=base_url('seaimport/add');?>" class="needs-validation" novalidate>
                <div class="modal fade" id="seaimportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="seaimportModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title fw-bold poppins text-secondary" id="seaimportModalLabel">Sea import Rate</h6>
        ...
        <form action="<?=base_url('seaimport/updatenotes');?>" method="post">

            <div class="modal fade" id="seaimportNotes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="seaimportNoteslabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title fw-bold poppins text-secondary" id="seaimportNoteslabel">Editor's Note</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                        <div class="modal-body poppins">
                        <?php if ($note) : ?>
    ...
    <script src="<?=base_url('js/seaimport.js');?>"></script>