...
<div class="container">
    ...
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <h5 class="text-uppercase">Air Import Rates</h5>
        <div class="">
        ...
        <div class="row">
            ...
            <?php if($this->session->user_type == 'Editor'): ?>
                ...
                <div class="text-start col mb-2">
                    <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#airimportModal">New Rate <i class="fas fa-plus fa-fw"></i></button>
                </div>
        ...
        <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#airimportModalNotes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>
        </div>
        ...
        <div class="mb-2 bg-light p-4 border border-secondary rounded" >
            ...
            <tbody >
                ...
                if ($airimport) {
                    ...
                    foreach($airimport->getResult() as $rate)
                    {
                  ?>
                       <tr>
                       ...
                       <?php if($this->session->user_type == 'Editor'): ?>
                            ...
                            <td><a href="<?=base_url('airimport/remove/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
                        <?php endif; ?>
                ...
                {
                    echo '<tr>
                                <td colspan="23" class="text-danger"> No Result </td>
                          <tr>';
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <form method="POST" action="<?=base_url('airimport/add');?>" class="needs-validation" novalidate>
                <div class="modal fade" id="airimportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="airimportModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title fw-bold poppins text-secondary" id="airimportModalLabel">Air Import Rate</h6>
    ...
    <form action="<?=base_url('airimport/updatenotes');?>" method="post">

        <div class="modal fade" id="airimportModalNotes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="airimportModalNoteslabel" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                  <div class="modal-header">
                      <h6 class="modal-title fw-bold poppins text-secondary" id="airimportModalNoteslabel">Editor's Note</h6>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                      <div class="modal-body poppins">
                      <?php if ($note) : ?>
...
<script src="<?=base_url('js/airimport.js');?>"></script>