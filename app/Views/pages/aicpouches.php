...
<div class="container">
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <?php  $this->session = \Config\Services::session(); ?>
            ...
            <h5 class="text-uppercase">POUCHES</h5>
    ...
    <div class="row">
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <div class="text-start col mb-2">
                <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#aic_pouches_modal">New Rate <i class="fas fa-plus fa-fw"></i></button>
            </div>

        <?php endif; ?>

        <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#aic_pouches_notes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>

    </div>

    <div class="mb-2 bg-light p-4 border border-secondary rounded" >
        <h6 class="fw-bold p-2 text-center text-danger">VOLUME: 2000 & UP AWB/MONTH</h6>
         <table class="table table-striped table-responsive" style="width:100%; overflow-x:auto;">
            ...
            <tbody>
                ...
                <?php if($aicpouches): ?>
                    ...
                    <?php foreach($aicpouches->getResult() as $rate ): ?>

                        <?php if($rate->category == 'SET_A'): ?>

                        <tr>
                            <?php if($this->session->user_type == 'Editor'): ?>
                                
                                <td><button type="button" class="btn btn-primary btn-sm edit" id="edit" >Edit</button></td>
                                <td><a href="<?=base_url('aicpouches/delete/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
    ...
    <div class="mb-2 mt-5 bg-light p-4 border border-secondary rounded" >
                    ...
                    <h6 class="fw-bold p-2 text-center text-danger">VOLUME: BELOW 2000 AWB/MONTH</h6>
    ...
    <?php if($this->session->user_type == 'Editor'): ?>
        <form method="post" action="<?=base_url('aicpouches/add');?>" class="needs-validation" novalidate >
            
            <div class="modal fade" id="aic_pouches_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="aic_mailers_modallabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-bold poppins text-secondary" id="aic_mailers_modallabel">Pouches</h6>
                            ...
                            <div class="modal-body poppins">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <option value="SET_A">VOLUME: 2000 & UP AWB/MONTH</option>
                                        <option value="SET_B">VOLUME: BELOW 2000 AWB/MONTH</option>
                                        </select>
    ...
    <?php endif; ?>
        ...
        <form action="<?=base_url('aicpouches/updatenotes');?>" method="post">

             <div class="modal fade" id="aic_pouches_notes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="asp_air_freight_noteslabel" aria-hidden="true">
...
<script src="<?=base_url('js/aicpouches.js');?>"></script>