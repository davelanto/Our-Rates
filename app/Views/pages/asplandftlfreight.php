...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="text-end col mb-2">
            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#asp_land_freight_ftl_notes">Editor's note<i class="far fa-clipboard fa-fw"></i></button>
        </div>
    ...
    <form action="<?=base_url('asplandftlfreight/updatenotes');?>" method="post">

        <div class="modal fade" id="asp_land_freight_ftl_notes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="asp_land_freight_ftl_noteslabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title fw-bold poppins text-secondary" id="asp_land_freight_ftl_noteslabel">Editor's Note</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    <div class="modal-body poppins">
                    <?php if ($note) : ?>
