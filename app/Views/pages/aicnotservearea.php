...
<div class="container">
    <div class="text-center mx-auto mt-5 mb-5">
        ...
        <?php  $this->session = \Config\Services::session(); ?>
            ...
            <h4 class="text-uppercase">NOT SERVE AREAS</h4>
    ...
    <div class="row">
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
            ...
            <div class="text-start col mb-2">
                <button class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#aic_not_serve_area_modal">New Rate <i class="fas fa-plus fa-fw"></i></button>
            </div>
    ...
    <div class="mb-2 bg-light p-4 border border-secondary rounded" >
         <table class="table table-striped table-responsive" style="width:100%; overflow-x:auto;">
            ...
            <tbody>
                ...
                <?php if($aicnotservearea): ?>

                    <?php foreach($aicnotservearea->getResult() as $rate ): ?>
                        ...
                        <tr>
                            <?php if($this->session->user_type == 'Editor'): ?>
                                ...
                                <td><a href="<?=base_url('aicnotservearea/delete/'. $rate->id); ?>" class="btn btn-sm btn-danger">Delete</a></td>
        ...
        <?php if($this->session->user_type == 'Editor'): ?>
        <form method="post" action="<?=base_url('aicnotservearea/add');?>" class="needs-validation" novalidate >
            
            <div class="modal fade" id="aic_not_serve_area_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="aic_not_serve_area_modallabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-bold poppins text-secondary" id="aic_not_serve_area_modallabel">NOT SERVE AREAS</h6>
...
<script src="<?=base_url('js/aicnotservearea.js');?>"></script>